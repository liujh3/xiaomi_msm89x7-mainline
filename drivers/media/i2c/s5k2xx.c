...
#define S5K2XX_LINK_FREQ_696MHZ 696000000
...
static const struct reg_sequence s5k3p3sx_init[] = {
	{ 0x6010, 0x0001 },
	{ 0x6214, 0x7971 },
	{ 0x6218, 0x0100 },
	{ 0xf408, 0x0048 },
...
static const struct reg_sequence s5k3p3sx_mode_4608x3456_regs[] = {
	{ 0x6028, 0x4000 },
	{ 0x3d7c, 0x1110 },
	{ 0x3d88, 0x0064 },
	{ 0x3d8a, 0x0068 },
...
static const struct s5k2xx_mode s5k3p3sx_modes[] = {
	{
		.width = 4608,
		.height = 3456,
		.fps = 30,
		...
		.fll_min = 3626,
		.llp = 5148,
		.link_freq_index = S5K2XX_LINK_FREQ_696MHZ_INDEX,
		.regs = s5k3p3sx_mode_4608x3456_regs,
		.num_regs = ARRAY_SIZE(s5k3p3sx_mode_4608x3456_regs),
	},
};

static struct s5k2xx_data s5k3p3sx_data = {
	.model = "s5k3p3sx",
	.chip_id = 0x3103,
	.modes = s5k3p3sx_modes,
	.num_modes = ARRAY_SIZE(s5k3p3sx_modes),
	.init_regs = s5k3p3sx_init,
	.num_init_regs = ARRAY_SIZE(s5k3p3sx_init),
};
...
static const struct of_device_id s5k2xx_of_match[] = {
	...
	{ .compatible = "samsung,s5k3p3sx", &s5k3p3sx_data },
