...
static int hx8394f_boe_on(struct hx8394f_boe *ctx)
{
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb9, 0xff, 0x83, 0x94);
	mipi_dsi_dcs_exit_sleep_mode_multi(&dsi_ctx);
	mipi_dsi_msleep(&dsi_ctx, 120);
	mipi_dsi_dcs_set_display_on_multi(&dsi_ctx);
	mipi_dsi_usleep_range(&dsi_ctx, 10000, 11000);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc9, 0x13, 0x00, 0x1c);
...
static const struct drm_display_mode hx8394f_boe_mode = {
	.clock = (720 + 156 + 24 + 156) * (1280 + 15 + 4 + 12) * 60 / 1000,
	.hdisplay = 720,
	.hsync_start = 720 + 156,
	.hsync_end = 720 + 156 + 24,
	.htotal = 720 + 156 + 24 + 156,
	.vdisplay = 1280,
	.vsync_start = 1280 + 15,
	.vsync_end = 1280 + 15 + 4,
	.vtotal = 1280 + 15 + 4 + 12,
...
static int hx8394f_boe_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct hx8394f_boe, panel,
				   &hx8394f_boe_panel_funcs,
...
static const struct of_device_id hx8394f_boe_of_match[] = {
	{ .compatible = "xiaomi,prada-hx8394f-boe" }, // FIXME
	{ /* sentinel */ }
};
...
static struct mipi_dsi_driver hx8394f_boe_driver = {
	...
	.driver = {
		.name = "panel-xiaomi-prada-hx8394f-boe",
...
MODULE_DESCRIPTION("DRM driver for BOE_hx8394F_720p_video_mode_dsi_panel");
MODULE_LICENSE("GPL");
