...
static int djn_570_v0_unprepare(struct drm_panel *panel)
{
	struct djn_570_v0 *ctx = to_djn_570_v0(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static const struct drm_display_mode djn_570_v0_mode = {
	.clock = (720 + 192 + 8 + 20) * (1440 + 255 + 2 + 6) * 60 / 1000,
	.hdisplay = 720,
	.hsync_start = 720 + 192,
	.hsync_end = 720 + 192 + 8,
	.htotal = 720 + 192 + 8 + 20,
	.vdisplay = 1440,
	.vsync_start = 1440 + 255,
	.vsync_end = 1440 + 255 + 2,
	.vtotal = 1440 + 255 + 2 + 6,
	.width_mm = 65,
	.height_mm = 130,
...
static const struct drm_panel_funcs djn_570_v0_panel_funcs = {
	.prepare = djn_570_v0_prepare,
	.unprepare = djn_570_v0_unprepare,
	.get_modes = djn_570_v0_get_modes,
};

static int djn_570_v0_probe(struct mipi_dsi_device *dsi)
{
...
static void djn_570_v0_remove(struct mipi_dsi_device *dsi)
{
	struct djn_570_v0 *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id djn_570_v0_of_match[] = {
	{ .compatible = "motorola,jeter-570-djn" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, djn_570_v0_of_match);

static struct mipi_dsi_driver djn_570_v0_driver = {
	.probe = djn_570_v0_probe,
	.remove = djn_570_v0_remove,
	.driver = {
		.name = "panel-motorola-jeter-570-djn",
		.of_match_table = djn_570_v0_of_match,
	},
};
module_mipi_dsi_driver(djn_570_v0_driver);

MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <fix@me>"); // FIXME
MODULE_DESCRIPTION("DRM driver for mipi_mot_video_djn_hd_570");
MODULE_LICENSE("GPL");
