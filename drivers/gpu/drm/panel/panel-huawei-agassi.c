...
static int huawei_agassi_panel_enable(struct drm_panel *panel)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x84, 0x55);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x1, 0x0);
	msleep(20);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x83, 0x96);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x84, 0x69);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa9, 0xff);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xaa, 0xfe);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xab, 0xfa);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xac, 0xf7);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xad, 0xf3);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xae, 0xf1);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xaf, 0xed);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb0, 0xeb);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1, 0xe9);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb2, 0xe6);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbd, 0x1c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbe, 0x30);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xbf, 0x30);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x98, 0xc);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x97, 0x80);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x96, 0x63);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x95, 0x0);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x83, 0x0);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x84, 0x0);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x96, 0xc0);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x10, 0x0);
